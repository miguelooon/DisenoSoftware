...
const Cart = () => {
  ...
  return(
    <div className={styles.carrito_cont}>
      <div  onClick= {()=>{setCartOpen(!cartOpen)}} className={styles.boton_cart_cont}>
        <div className={styles.boton_cart}>

          {!cartOpen ? (

            <svg className={styles.open} width={"35px"} viewBox="0 0 30 27"fill="none">
              <path
        ...
        {!cartOpen && productsLength !==0 && <div className={styles.product_number}>
